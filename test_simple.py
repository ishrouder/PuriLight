...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Simple testing function for PuriLightX models.')

    parser.add_argument('--image_path', type=str,
                        help='path to a test image or folder of images', required=True)

    parser.add_argument('--load_weights_folder', type=str,
                        help='path of a weights model to use',
                        )
    ...
    parser.add_argument('--model', type=str,
                        help='name of a weights model to use',
...
def test_simple(args):
    ...
    print("   Loading weights encoder")
    encoder = networks.PuriLightX(model=args.model,
                                    height=feed_height,
                                    width=feed_width)
